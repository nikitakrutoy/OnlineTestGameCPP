...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnMatchFound, bool, bWasFound);

UCLASS()
class ONLINETESTGAMECPP_API UGCGameInstance : public UGameInstance
{
	GENERATED_BODY()
...
public:
	...
	void LaunchLobby(int32 MaxPlayers_In, FName ServerName_In, bool bIsLAN);
